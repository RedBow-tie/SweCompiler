...
form ed_help ()
    layout "Syntax" sysmenu maxbox minibox
e           a                     
...
pre
    ...
    .columnwidth ( V_GRP, "150" )
    .additemy ( V_GRP, "Functions|Form|Triggers|Instructions|Sql|Widgets|Widgets_const|#defines|Keys|Document|Version" )
